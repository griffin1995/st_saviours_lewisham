  ...
  return (
    <section className="py-24 bg-slate-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-12 relative z-10">
        ...
        {/* Events Cards with enhanced layout and animations */}
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {upcomingEvents.map((event, index) => (
            ...
            >
              <motion.div
                className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-500 h-full flex flex-col events-card-container"
                whileHover={prefersReducedMotion ? {} : { y: -8, scale: 1.02 }}
                transition={prefersReducedMotion ? {} : { type: "spring", stiffness: 300, damping: 30 }}
              >
                {/* Enhanced event card header */}
                <div className="p-8 flex-1 events-card-content flex flex-col">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    >
                      <div className="w-14 h-14 bg-gradient-to-br from-gray-700 to-gray-800 rounded-xl flex items-center justify-center shadow-lg events-icon-background">
                  ...
                  <div className="flex-1">
                    <motion.h3
                      className="text-xl font-serif font-semibold text-gray-900 mb-4 group-hover:text-gray-700 transition-colors duration-300"
                      initial={{ opacity: 0 }}
                  ...
                  {/* Enhanced action area - Fixed at bottom */}
                  <motion.div
                    className="pt-4"
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                  ...
                  >
                    <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                      ...
                      <motion.a
                        ...
                        className="group/link inline-flex items-center text-gray-800 hover:text-gray-900 focus:text-gray-900 font-semibold transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 rounded"
