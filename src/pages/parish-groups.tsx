...
export default function ParishGroups() {
  ...
  const [groupStats, setGroupStats] = useState<{
    [key: string]: { members: number; activities: number; engagement: number };
  }>({});
  const [registrationMode, setRegistrationMode] = useState(false);
  const [selectedGroupForReg, setSelectedGroupForReg] = useState<string | null>(
    null
  );
  ...
  const groups = [
    {
      ...
      icon: Heart,
      description:
        "Caring for those in need in our local community through practical support and friendship.",
    ...
    },
    {
      ...
      icon: Music,
      description:
        "Leading worship through music at Sunday Mass and special celebrations.",
    ...
    },
    {
      ...
      icon: BookOpen,
      description:
        "Exploring God's word together through weekly Bible study and prayer.",
    ...
    },
    {
      ...
      icon: Baby,
      description:
        "A welcoming space for parents and carers with young children to meet and socialize.",
    ...
    },
    {
      ...
      icon: Coffee,
      description:
        "Social time and community building after Sunday morning Mass.",
    ...
    },
    {
      ...
      icon: Cross,
      description:
        "Young people assisting at Mass and developing leadership skills.",
    ...
    },
    {
      ...
      icon: Globe,
      description:
        "Working for social justice and care of creation in our world.",
  ...
  const benefits = [
    {
      ...
      title: "Grow in Faith",
      description:
        "Deepen your understanding of Scripture, prayer, and Catholic teaching through study and discussion.",
    },
    {
      icon: Users,
      title: "Build Community",
      description:
        "Form lasting friendships with fellow parishioners who share your values and commitment to faith.",
    },
    {
      icon: Globe,
      title: "Serve Others",
      description:
        "Put your faith into action by serving those in need in our parish and the wider community.",
    },
  ];
  ...
  useEffect(() => {
    actions.addNotification({
      type: "info",
      message:
        "Welcome to Parish Groups - find your place in our vibrant community",
      dismissible: true,
    });
  ...
  const groupEngagementData = {
    labels: groups
      .slice(0, 6)
      .map((group) => group.name.substring(0, 15) + ".."),
    datasets: [
      {
        label: "Active Members",
        data: groups
          .slice(0, 6)
          .map((group) => groupStats[group.name]?.members || 0),
      ...
      },
      {
        ...
        data: groups
          .slice(0, 6)
          .map((group) => groupStats[group.name]?.activities || 0),
  ...
  const steps = [
    {
      ...
      description:
        "Browse our groups and find one that matches your interests, schedule, and stage of life.",
      color: "bg-blue-600",
    },
    {
      number: 2,
      title: "Make Contact",
      description:
        "Reach out using the contact information provided or speak to someone after Mass.",
      color: "bg-green-600",
    },
    {
      number: 3,
      title: "Come Along",
      description:
        "Attend a meeting or event - most groups welcome visitors and new members at any time.",
      color: "bg-purple-600",
    },
  ];
      ...
      <Section spacing="lg" background="white">
        <Container size="lg">
          ...
          >
            ...
            >
              At St Saviour's, we believe that faith grows best in community.
              Our parish groups offer opportunities to deepen your relationship
              with God, build meaningful friendships, and serve others in need.
            </Text>
          </animated.div>
          ...
          <Container size="lg">
            <animated.div ref={analyticsRef} style={analyticsSpring}>
              <div className="text-center mb-12">
                ...
                >
                  See how our parish groups are thriving and growing together in
                  faith
                </p>
              </div>
          ...
          <ScrollRevealSection>
            ...
            >
              ...
              <p
                className={`${typographyScale.bodyLarge} text-gray-600 max-w-3xl mx-auto`}
              >
                Can't attend in person? Join our groups online for prayer,
          ...
          <ScrollRevealSection>
            ...
            >
              ...
              <p
                className={`${typographyScale.bodyLarge} text-gray-100 max-w-3xl mx-auto`}
              >
                Sign up for groups quickly and securely with our streamlined
        ...
        <Container size="lg">
          ...
          <Grid cols={3} gap="lg" className="mb-16">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 ${step.color} rounded-full flex items-center justify-center mx-auto`}
                >
            ...
            >
              <CardContent>
                <div className="text-center space-y-6">
                  ...
                  >
                    We're always open to starting new groups based on the
                    interests and needs of our parishioners. Have an idea for a
                    new ministry or group? We'd love to hear from you.
                  </Text>
          ...
          <ScrollRevealSection>
            ...
            >
              ...
              <p
                className={`${typographyScale.bodyLarge} text-gray-600 max-w-3xl mx-auto`}
              >
                Hear how parish groups have enriched the faith journeys of our
                community members
              </p>
            </m.div>
          ...
          <ScrollRevealSection>
            ...
            >
              ...
              <p
                className={`${typographyScale.bodyLarge} text-gray-100 max-w-3xl mx-auto`}
              >
                Share prayer requests within your groups and lift each other up
                in faith
              </p>
            </m.div>
