...
const venues: Venue[] = [
  {
    ...
    name: "Parish Hall",
    description:
      "Our spacious main hall is perfect for large gatherings, celebrations, and community events. With a stage area and excellent acoustics, it's ideal for both formal and informal occasions.",
  ...
  },
  {
    ...
    name: "Community Room",
    description:
      "A comfortable, intimate space perfect for smaller gatherings, meetings, and family celebrations. Features beautiful stained glass windows and a warm, welcoming atmosphere.",
  ...
  },
  {
    ...
    name: "Church Garden",
    description:
      "Our beautiful, peaceful garden provides a unique outdoor venue surrounded by mature trees and well-maintained grounds. Perfect for outdoor ceremonies and summer events.",
...
const faqs = [
  {
    ...
    answer:
      "All venue hire includes basic furniture (tables and chairs), lighting, heating, and access to basic kitchen facilities. Additional equipment like sound systems or decorative items may incur extra charges.",
  },
  {
    question: "How far in advance should I book?",
    answer:
      "We recommend booking at least 6-8 weeks in advance for popular dates, especially weekends. Some dates may be available with shorter notice.",
  },
  {
    question: "Are there any restrictions on what I can hold?",
    answer:
      "As a Catholic parish, we ask that all events align with our Christian values. We welcome community celebrations, educational events, and charitable fundraisers. Please discuss your event with us.",
  },
  {
    question: "Is parking available?",
    answer:
      "Yes, we have an on-site car park with 25 spaces. Additional street parking is available nearby.",
  },
  {
    question: "Can I bring my own catering?",
    answer:
      "Yes, you can bring your own catering or use our approved caterers list. Our kitchen facilities are available for food preparation and service.",
  },
  {
    question: "What about decorations?",
    answer:
      "You're welcome to decorate the venues appropriately. We ask that no fixtures are damaged and all decorations are removed after your event.",
  },
];
...
export default function VenueHire() {
  ...
  const [bookingStats, setBookingStats] = useState<{
    [key: string]: { bookings: number; revenue: number; rating: number };
  }>({});
  ...
  useEffect(() => {
    actions.addNotification({
      type: "info",
      message:
        "Welcome to Venue Hire - discover our beautiful spaces for your special events",
      dismissible: true,
    });
  ...
  const handleVenueComparison = useCallback(
    (venueId: string) => {
    ...
    datasets: [
      {
        ...
        borderColor: ["#d4af37", "#1a365d", "#16a34a"],
        borderWidth: 1,
      },
    ],
  };
        ...
        <Container size="lg">
          <ScrollRevealSection>
            ...
            >
              ...
              >
                Welcoming all into spaces where community flourishes and
                memories are made
              </p>
            </m.div>
      ...
      <Section spacing="lg" background="white">
        <Container size="lg">
          ...
          >
            ...
            >
              St Saviour's parish offers beautiful, well-maintained venues in
              the heart of Lewisham. Whether you're planning a wedding
              reception, birthday celebration, community meeting, or corporate
              event, our flexible spaces provide the perfect setting for your
              special occasion.
            </Text>
          </animated.div>
            ...
            {[
              {
                ...
                description:
                  "Beautiful Victorian buildings with character and charm",
              },
              {
                icon: Heart,
                title: "Community Spirit",
                description:
                  "Supporting local families and community organizations",
              },
              {
                icon: Star,
                title: "Excellent Value",
                description:
                  "Competitive rates with all proceeds supporting parish work",
              },
            ].map((benefit, index) => (
              <m.div
                key={index}
          ...
          <ScrollRevealSection>
            ...
            >
              ...
              <p
                className={`${typographyScale.bodyLarge} text-gray-100 max-w-3xl mx-auto`}
              >
                Check real-time availability and find the perfect date for your
                event
              </p>
            </m.div>
      ...
      <Section spacing="lg" background="white">
        <Container size="lg">
          ...
          >
            ...
            >
              Choose from our range of flexible spaces to suit events of all
              sizes
            </Text>
          </m.div>
            ...
            {[
              {
                ...
                title: "Contact Us",
                description:
                  "Call or email to check availability and discuss your requirements",
                icon: Phone,
              },
              {
                step: "2",
                title: "Visit & View",
                description:
                  "Arrange a viewing to see the venue and discuss your specific needs",
                icon: Building,
              },
              {
                step: "3",
                ...
                description:
                  "Complete our booking form and pay the deposit to secure your date",
                icon: CheckCircle,
              },
              {
                step: "4",
                title: "Your Event",
                description:
                  "Enjoy your special day with our support and beautiful venue",
                icon: PartyPopper,
              },
            ].map((step, index) => (
              <m.div
          ...
          <Grid cols={2} gap="xl" className="items-start">
            ...
            >
              ...
              <Text size="xl" className="text-gray-200 mb-8 leading-relaxed">
                Ready to book your venue or have questions? Our friendly team is
                here to help make your event a success.
              </Text>
