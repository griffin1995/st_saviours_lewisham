              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 space-y-2">
                  <div className="flex items-center justify-between">
                    <Text className="font-medium text-white">{pref.category}</Text>
                    <button
                  ...
                  <Text className="text-sm text-gray-300">{pref.description}</Text>
                </div>
              </div>
            </motion.div>
          ))}
...
const GDPRComplianceTracker = () => {
  const [dataRequests, setDataRequests] = useState([
    { type: 'Access Request', status: 'pending', date: '2025-01-10', id: 'DR001' },
    { type: 'Data Export', status: 'completed', date: '2025-01-08', id: 'DR002' },
    { type: 'Data Deletion', status: 'processing', date: '2025-01-12', id: 'DR003' }
  ])
  const [requestType, setRequestType] = useState<'access' | 'export' | 'deletion'>('access')
  ...
  const submitRequest = async () => {
    ...
    const newRequest = {
      type: requestType === 'access' ? 'Access Request' : requestType === 'export' ? 'Data Export' : 'Data Deletion',
      status: 'pending',
        ...
        <div className="space-y-4">
          ...
          <animated.div style={springProps}>
            <Button
              ...
              leftIcon={isSubmitting ? <Clock className="h-4 w-4 animate-spin" /> : <Share className="h-4 w-4" />}
            >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-3 h-3 rounded-full ${
                      ...
                      request.status === 'processing' ? 'bg-yellow-500' : 'bg-blue-500'
                    }`} />
                    <div>
                      <Text className="text-sm font-medium text-white">{request.type}</Text>
                      <Text className="text-xs text-gray-400">#{request.id}</Text>
                    </div>
                  </div>
                  <div className="text-right">
                    <Text className={`text-xs font-medium capitalize ${
                      request.status === 'completed' ? 'text-green-400' : 
                      request.status === 'processing' ? 'text-yellow-400' : 'text-blue-400'
                    }`}>
                      {request.status}
                    </Text>
                    <Text className="text-xs text-gray-400">{request.date}</Text>
                  </div>
                </div>
              </motion.div>
            ))}
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="sr-only">
          <h1>Privacy Policy page loaded with interactive privacy controls and GDPR compliance tracker</h1>
          <p>Use Alt+P to access privacy controls, Alt+G for GDPR compliance, Alt+A for analytics</p>
        </div>
            ...
            actions={
              <Flex justify="center" gap="md">
                <Button 
                  ...
                  onClick={() => document.getElementById('privacy-controls')?.scrollIntoView({ behavior: 'smooth' })}
                  onKeyDown={(e) => e.key === 'p' && document.getElementById('privacy-controls')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  Privacy Controls
                </Button>
                <Button 
                  ...
                  className="border-white text-white hover:bg-white hover:text-slate-900"
                  onClick={() => document.getElementById('gdpr-compliance')?.scrollIntoView({ behavior: 'smooth' })}
                >
                  GDPR Centre
                </Button>
              </Flex>
          ...
          <Container size="lg">
            <animated.div style={fadeInSpring}>
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                ...
                <Card variant="outlined" padding="lg" className="bg-white/10 backdrop-blur-sm border border-slate-600">
                  <CardContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <Text className="text-gray-300">
                            <Text weight="bold" className="text-white">Data Controller:</Text> St Saviour's Catholic Church
                          </Text>
                          <Text className="text-gray-300">
                            <Text weight="bold" className="text-white">Address:</Text> 3 Vesta Road, Lewisham, London SE13 6QJ
                          </Text>
                          <Text className="text-gray-300">
                          ...
                          <Text className="text-gray-300">
                            <Text weight="bold" className="text-white">Data Protection Officer:</Text> Available on request via the contact details above
                          </Text>
                        </div>
                      </div>
                    </Flex>
                ...
                <div>
                  ...
                  <Text className="text-gray-300 leading-relaxed">
                    This privacy policy was last updated on <Text weight="bold" className="text-white">1st January 2025</Text>. We may update 
            ...
            <div className="space-y-12">
              <div className="text-center space-y-6">
                ...
                <Text size="lg" className="text-gray-300 max-w-2xl mx-auto">
                  Manage your privacy preferences and control how your data is used by our parish systems.
                </Text>
              </div>
          ...
          <Container size="lg">
            <div className="space-y-12">
              <div className="text-center space-y-6">
                ...
                <Text size="lg" className="text-gray-300 max-w-2xl mx-auto">
                  Exercise your data protection rights with our comprehensive GDPR compliance tools.
                </Text>
              </div>
          ...
          <Container size="lg">
            <div className="space-y-12">
              <div className="text-center space-y-6">
                ...
                <Text size="lg" className="text-gray-300 max-w-2xl mx-auto">
                  Understanding our data collection methods helps you make informed decisions about your privacy.
                </Text>
              </div>
                ...
                {[
                  {
                    ...
                    description: "When you register for events, sign up for newsletters, or contact us",
                    color: "blue"
                  },
                  {
                    icon: Globe,
                    title: "Website Usage",
                    description: "Automatically through cookies and analytics when you visit our website",
                    color: "green"
                  },
                  {
                    icon: FileText,
                    title: "Third Parties",
                    description: "From other organizations with your consent (e.g., diocesan records)",
                    color: "purple"
                  }
                ].map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <Card variant="default" padding="lg" className="bg-white/10 backdrop-blur-sm border border-slate-600 text-center hover:border-blue-500 transition-all duration-300">
                      <CardContent>
                  ...
                  >
                    ...
                    >
                      <CardContent>
                        ...
                        <div className="space-y-3">
                          <div>
                            <Heading level="h4" className="text-sm font-semibold text-blue-400 mb-1">
                              Examples:
                            </Heading>
                            <Text size="sm" className="text-gray-300">
        ...
        <Section spacing="lg" background="slate">
          <Container size="xl">
            <div className="text-center mb-12">
              ...
              <Text size="xl" align="center" className="max-w-3xl mx-auto text-gray-300">
            ...
            <div className="space-y-12">
              ...
              <Grid cols={2} gap="lg" className="grid-cols-1 lg:grid-cols-2">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card variant="default" padding="lg" className="bg-white/10 backdrop-blur-sm border border-slate-600 hover:border-blue-500 transition-all duration-300">
                    <CardContent>
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card variant="default" padding="lg" className="bg-white/10 backdrop-blur-sm border border-slate-600 hover:border-red-500 transition-all duration-300">
                    <CardContent>
                      <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4">
                      ...
                      <div className="space-y-2 text-left">
                        <Text size="sm" className="text-gray-300">
                          <Text weight="bold" className="text-white">Website:</Text> ico.org.uk
                        </Text>
                        <Text size="sm" className="text-gray-300">
                          <Text weight="bold" className="text-white">Phone:</Text> 0303 123 1113
                        </Text>
                        <Text size="sm" className="text-gray-300">
                          <Text weight="bold" className="text-white">Post:</Text> Information Commissioner's Office, Wycliffe House, Water Lane, Wilmslow, Cheshire SK9 5AF
                        </Text>
                      </div>
                    </CardContent>
                  </Card>
          ...
          <Container size="md">
            <div className="text-center text-white space-y-8">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <Text size="lg" className="text-gray-300 max-w-2xl mx-auto">
                    We're committed to protecting your personal data and ensuring transparency in how we handle your information.
                  </Text>
  ...
  document.addEventListener('keydown', (e) => {
    if (e.altKey) {
      switch (e.key.toLowerCase()) {
        case 'p':
          e.preventDefault()
          document.getElementById('privacy-controls')?.scrollIntoView({ behavior: 'smooth' })
          break
        case 'g':
          e.preventDefault()
          document.getElementById('gdpr-compliance')?.scrollIntoView({ behavior: 'smooth' })
          break
        case 'a':
          e.preventDefault()
