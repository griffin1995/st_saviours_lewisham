  ...
  const recentNewsletters = [
    {
      ...
      date: "2025-01-26",
      description:
        "Fourth Sunday in Ordinary Time - Parish updates, upcoming events, and spiritual reflections.",
    ...
    },
    {
      ...
      date: "2025-01-19",
      description:
        "Third Sunday in Ordinary Time - Week of Prayer for Christian Unity special feature.",
    ...
    },
    {
      ...
      date: "2025-01-12",
      description:
        "Baptism of the Lord - New Year parish initiatives and ministry opportunities.",
    ...
    },
    {
      ...
      date: "2025-01-05",
      description:
        "Epiphany of the Lord - Christmas season reflections and upcoming Lenten preparations.",
    ...
    },
    {
      ...
      date: "2024-12-29",
      description:
        "Holy Family Sunday - Year-end gratitude and New Year resolutions.",
    ...
    },
    {
      ...
      date: "2024-12-22",
      description:
        "Fourth Sunday of Advent - Final Christmas preparations and Christmas Mass schedule.",
      ...
      <ContentSection background="white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Each week, our newsletter provides everything you need to stay
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                All parish events, special celebrations, and important dates for
                the coming week.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Weekly reflections on the Sunday Gospel and seasonal spiritual
                guidance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Important announcements, parish news, and updates on ongoing
                projects.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <p className="text-sm text-gray-600">
                Weekly Mass times, intentions, and any changes to the regular
                schedule.
              </p>
            </div>
          </div>
      ...
      <ContentSection background="white">
        <div className="text-center text-white">
          ...
          <p className="text-gray-300 mb-8 max-w-3xl mx-auto text-lg">
            We maintain an archive of all parish newsletters going back several
            years. If you're looking for a specific edition or want to catch up
            on parish history, we're happy to help.
          </p>
      ...
      <ContentSection background="white">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Have news to share? Organizing an event? Want to contribute a
            reflection or article? We welcome submissions from parishioners for
