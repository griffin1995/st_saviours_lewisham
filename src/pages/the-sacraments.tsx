...
const sacraments: Sacrament[] = [
  ...
  },
  {
    ...
    icon: Cross,
    description:
      "Completes Christian initiation and strengthens us with the gifts of the Holy Spirit.",
    details:
      "Confirmation deepens baptismal grace and roots us more deeply in divine filiation.",
  ...
  },
  {
    ...
    icon: Cookie,
    description:
      "The source and summit of Christian life, the Body and Blood of Christ.",
    details:
      "In Holy Communion, we receive Christ himself and are united with him and each other.",
  ...
  },
  {
    ...
    icon: Heart,
    description:
      "The sacrament of forgiveness and reconciliation with God and the Church.",
    details:
      "Through confession, we receive God's mercy and are restored to grace.",
  ...
  },
  {
    ...
    icon: Plus,
    description:
      "Brings spiritual and sometimes physical healing to those who are seriously ill.",
    details:
      "This sacrament provides comfort, courage, and spiritual strength in times of illness.",
  ...
  },
  {
    ...
    details:
      "Through Holy Orders, men are consecrated to serve God and his people.",
  ...
  },
  {
    ...
    icon: Gem,
    description:
      "The sacred covenant between a man and woman that mirrors Christ's love for the Church.",
    details:
      "Marriage is a lifelong partnership ordered toward the good of the spouses and children.",
...
const sacramentCategories = [
  {
    ...
    icon: Droplets,
    description:
      "Baptism, Confirmation, and Eucharist lay the foundation of Christian life. They initiate us into the Church and establish our relationship with Christ.",
    sacraments: [
  ...
  },
  {
    ...
    icon: Heart,
    description:
      "Confession and Anointing of the Sick continue Jesus' work of healing and forgiveness. They restore us to spiritual health and strengthen us in times of need.",
    sacraments: [
  ...
  },
  {
    ...
    icon: HandMetal,
    description:
      "Holy Orders and Matrimony are directed toward the salvation of others. They consecrate people to serve God and the Church in specific ways.",
    sacraments: [
...
export default function TheSacraments() {
  ...
  const [selectedSacrament, setSelectedSacrament] = useState<string | null>(
    null
  );
  const [sacramentalStats, setSacramentalStats] = useState<{
    [key: string]: { participants: number; ceremonies: number; growth: number };
  }>({});
  ...
  const handleJourneyStep = useCallback(
    (sacramentName: string, stepProgress: number) => {
      setJourneyProgress((prev) => {
        const updated = { ...prev, [sacramentName]: stepProgress };
        localStorage.setItem(
          "sacramental-journey-progress",
    ...
    datasets: [
      {
        ...
        data: sacraments
          .slice(0, 7)
          .map(
            (sacrament) => sacramentalStats[sacrament.name]?.participants || 0
          ),
      ...
      },
      {
        ...
        data: sacraments
          .slice(0, 7)
          .map(
            (sacrament) => sacramentalStats[sacrament.name]?.ceremonies || 0
          ),
              ...
              <div className="space-y-8">
                <div className="relative">
                  <m.div
                    ...
                    whileInView={
                      reducedMotion ? { opacity: 1 } : { height: 48 }
                    }
                    transition={
                      reducedMotion
                        ? { duration: 0.3 }
                ...
                <Text size="xl" className="text-gray-100 leading-relaxed">
                  ...
                  instituted by Christ to sanctify us, to build up the body of
                  Christ, and to give worship to God. They are seven in number
                  and are celebrated in the Catholic Church as sacred encounters
                  with the living God.
                </Text>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Text className="text-gray-200">
                        Each sacrament is an outward sign that communicates
                        inward grace, making God's love tangible in our lives.
                      </Text>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Text className="text-gray-200">
                        Through the sacraments, Christ himself acts, touching
                        our hearts and transforming our souls.
                      </Text>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Text className="text-gray-200">
                        The sacraments unite us as one body in Christ, building
          ...
          <Container size="lg">
            <div className="space-y-12">
              <div className="text-center">
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex justify-center">
                    <m.div
                      ...
                      whileInView={
                        reducedMotion ? { opacity: 1 } : { width: 96 }
                      }
                      transition={
                        reducedMotion
                          ? { duration: 0.3 }
                ...
                >
                  Each sacrament has its own unique role in our spiritual
                  journey, from initiation to healing to service.
                </Text>
              </div>
          ...
          <Container size="lg">
            <Grid cols={2} gap="xl" className="items-start">
              ...
              <div className="space-y-8 text-right">
                ...
                <Text
                  size="xl"
                  className="text-gray-100 leading-relaxed text-right"
                >
                  The seven sacraments are organized into three meaningful
                  categories, each serving a distinct purpose in our spiritual
                  journey and relationship with God and the Church community.
                </Text>
                <Text className="text-gray-200 leading-relaxed text-right">
                  From the foundational sacraments of initiation that welcome us
                  into the faith, to the healing sacraments that restore us, and
                  the sacraments of service that call us to serve others - each
                  category reflects Christ's continuing presence in our lives
                  through the Church.
                </Text>
              </div>
            </Grid>
            ...
            <ScrollRevealSection>
              ...
              >
                ...
                <p
                  className={`${typographyScale.bodyLarge} text-gray-100 max-w-3xl mx-auto`}
                >
                  Get guided support and track your preparation for receiving
                  the sacraments
                </p>
              </m.div>
            ...
            <ScrollRevealSection>
              ...
              >
                ...
                <p
                  className={`${typographyScale.bodyLarge} text-gray-600 max-w-3xl mx-auto`}
                >
                  Schedule sacramental preparation and celebrations throughout
                  the liturgical year
                </p>
              </m.div>
            ...
            <ScrollRevealSection>
              ...
              >
                ...
                <p
                  className={`${typographyScale.bodyLarge} text-gray-100 max-w-3xl mx-auto`}
                >
                  Monitor your faith journey and celebrate milestones in your
                  sacramental life
                </p>
              </m.div>
            ...
            <ScrollRevealSection>
              ...
              >
                ...
                <p
                  className={`${typographyScale.bodyLarge} text-gray-600 max-w-3xl mx-auto`}
                >
                  Access comprehensive resources for sacramental preparation and
                  ongoing formation
                </p>
              </m.div>
            ...
            <div className="text-center text-white space-y-8">
              <div className="space-y-6">
                ...
                <Text size="lg" className="text-gray-300 max-w-3xl mx-auto">
                  Whether you're seeking baptism, preparing for confirmation, or
                  exploring any of the sacraments, we're here to guide and
