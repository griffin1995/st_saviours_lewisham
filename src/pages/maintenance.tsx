  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Our website is currently under maintenance. We'll be back shortly." />
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-2xl font-semibold text-white">Website Under Maintenance</h2>
            </div>
          ...
          >
            <h3 className="text-xl font-semibold text-white mb-4">Need to Contact Us?</h3>
