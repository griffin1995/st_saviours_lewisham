...
const podcastEpisodes: PodcastEpisode[] = [
  {
    ...
    description:
      "Join Fr Krisz as he explores the spiritual disciplines of Lent and how we can use this holy season to draw closer to God through prayer, fasting, and almsgiving.",
    host: "Fr Krisz",
    date: "2025-02-15",
    duration: "32 minutes",
  ...
  },
  {
    ...
    description:
      "Deacon Michael shares inspiring stories of contemporary saints and how their examples can guide our daily Christian living in the 21st century.",
    host: "Deacon Michael",
    date: "2025-02-01",
    duration: "28 minutes",
  ...
  },
  {
    ...
    description:
      "A deep dive into the structure and meaning of the Catholic Mass, helping parishioners participate more fully in our Sunday worship.",
    host: "Fr Krisz",
  ...
  },
  {
    ...
    description:
      "Youth leader Maria discusses innovative approaches to engaging young people in faith formation and community service.",
    host: "Deacon Michael",
  ...
  },
  {
    ...
    description:
      "Exploring how our various parish groups and ministries work together to create a vibrant, welcoming community for all.",
    host: "Fr Krisz",
    date: "2024-12-21",
    duration: "30 minutes",
  ...
  },
  {
    ...
    description:
      "Sr Catherine from the local convent shares practical advice on developing a meaningful prayer life that fits into our busy modern schedules.",
    host: "Deacon Michael",
    guest: "Sr Catherine",
    date: "2024-12-06",
    duration: "30 minutes",
...
export default function Podcasts() {
  ...
  const featuredEpisodes = podcastEpisodes.filter(
  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="status"
      >
        {currentlyPlaying && <div>Now playing episode {currentlyPlaying}</div>}
      </div>
      ...
      <main id="main-content" tabIndex={-1} className="focus:outline-none">
        {/* Enhanced Hero Section with Audio Visualization */}
          ...
          >
            ...
            <div
              className="absolute bottom-0 left-0 right-0 h-32 flex items-end justify-center gap-1 opacity-30"
              aria-hidden="true"
            >
            ...
            >
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  >
                    Our weekly podcast features discussions on Catholic
                    teaching, spiritual formation, and practical faith living.
                    Each episode offers insights to help you grow closer to God
                    and live out your Catholic faith with joy and purpose.
                  </Text>
                </m.div>
              </div>
          ...
          <Container size="lg">
            ...
            >
              ...
              <Text
                ...
                className="max-w-3xl mx-auto"
              >
                Browse our complete collection of faith conversations and
                spiritual content
              </Text>
            </m.div>
        ...
        <Section spacing="lg" background="slate">
          <Container size="lg">{/* <PodcastAnalytics /> */}</Container>
        </Section>
