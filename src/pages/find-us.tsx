...
export default function FindUs() {
  ...
  const accessibilityFeatures = [
    {
      ...
      description:
        "Full wheelchair access via the main entrance. Accessible seating areas available in the nave.",
    },
    {
    ...
    },
    {
      title: "Assistance",
      description:
        "Our ushers are always happy to provide assistance. Please don't hesitate to ask for help.",
    },
  ];
  ...
  const facilityInfo = [
    ...
    },
    {
      ...
      description:
        "Arrive 10 minutes early for Mass. Our welcomers will be happy to help you find a seat and provide any information you need.",
    },
  ];
    ...
    >
      ...
      <div className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50">
        <a
          ...
          onFocus={() =>
            setAnnouncements(["Skip to main content link focused"])
          }
        >
          Skip to main content
        </a>
      ...
      {/* Enhanced Hero Section with Parallax */}
        ...
        >
          ...
          >
            <SparklesIcon
              className="absolute top-1/4 left-1/4 h-6 w-6 text-gold-400"
              aria-hidden="true"
            />
            <HeartIcon
              className="absolute top-1/3 right-1/3 h-4 w-4 text-gold-300"
              aria-hidden="true"
            />
            <GlobeAltIcon
              className="absolute bottom-1/4 left-1/3 h-5 w-5 text-gold-500"
              aria-hidden="true"
            />
          </m.div>
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      onFocus={() =>
                        setAnnouncements(["Get directions button focused"])
                      }
                    >
                      Get Directions
                    </Button>
                    <span id="directions-help" className="sr-only">
                      Opens Google Maps with directions to St Saviour's Catholic
                      Church
                    </span>
                  </m.div>
                  <m.div
                  ...
                  >
                    <Button
                      ...
                      onFocus={() =>
                        setAnnouncements(["Call us button focused"])
                      }
                    >
                      Call Us
                    </Button>
                    <span id="phone-help" className="sr-only">
                      Call us directly at 020 8852 7411 for assistance with
                      directions
                    </span>
                  </m.div>
                </Flex>
        ...
        <Section spacing="lg" background="slate">
          <Container size="lg">
            ...
            >
              ...
              >
                We're conveniently located in central Lewisham with excellent
                transport links.
              </Text>
            </m.div>
          ...
          <Container size="lg">
            <Grid cols={2} gap="xl">
              ...
              <m.div
                ...
                transition={
                  reducedMotion ? { duration: 0.3 } : { duration: 0.6 }
                }
                viewport={{ once: true }}
                className="space-y-6"
              >
                  ...
                  {accessibilityFeatures.map((feature, index) => (
                    ...
                    >
                      <Card
                        variant="default"
                        padding="md"
                        className="bg-white/10 backdrop-blur-sm border border-slate-600 hover:border-white transition-all duration-300"
                      >
                        <CardContent>
            ...
            >
              <div className="space-y-6">
                ...
                <Text size="xl" className="text-gray-300 max-w-2xl mx-auto">
                  If you need specific directions or have any accessibility
                  requirements, please don't hesitate to contact us. We're here
                  to help.
                </Text>
              </div>
